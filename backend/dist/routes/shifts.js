...
router.post('/start', async (req, res) => {
    try {
       ...
       OUTPUT INSERTED.*
       VALUES (NEWID(), @storeId, @userId, @userName, 'open', @startTime, @startingCash, @createdAt, @updatedAt)`, { storeId, userId, userName, startTime: now, startingCash, createdAt: now, updatedAt: now });
