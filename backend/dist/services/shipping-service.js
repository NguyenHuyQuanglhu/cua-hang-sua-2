...
async function logShippingOrder(data) {
    try {
        await (0, index_1.query)(`INSERT INTO ShippingOrders (OrderID, Provider, TrackingCode, ShippingOrderID, Fee, Status, CreatedAt)
...
async function updateShippingStatus(trackingCode, status) {
    try {
        await (0, index_1.query)(`UPDATE ShippingOrders SET Status = @status, UpdatedAt = GETDATE() WHERE TrackingCode = @trackingCode`, { trackingCode, status });
    }
    catch (error) {
