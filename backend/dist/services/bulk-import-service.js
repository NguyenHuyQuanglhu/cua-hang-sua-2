...
async function importCustomers(customers, storeId) {
    ...
    for (let i = 0; i < customers.length; i++) {
        ...
        try {
            ...
            if (customer.phone) {
                const existing = await (0, db_1.executeQuery)(`SELECT id FROM Customers WHERE phone = @phone AND store_id = @storeId`, { phone: customer.phone, storeId });
             ...
             WHERE phone = @phone AND store_id = @storeId`, {
                    ...
                    // Insert new customer
                    await (0, db_1.executeQuery)(`INSERT INTO Customers (
