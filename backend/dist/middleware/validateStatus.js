...
exports.validateAndNormalizeStatus = validateAndNormalizeStatus;
exports.validateStatusQuery = validateStatusQuery;
 ...
 */
function validateAndNormalizeStatus(req, res, next) {
    ...
    if (req.body && req.body.status !== undefined) {
        try {
            ...
            req.body.status = statusMapper_1.StatusMapper.normalize(req.body.status);
...
function validateStatusQuery(req, res, next) {
    ...
    if (req.query && req.query.status !== undefined) {
        ...
        try {
            ...
            req.query.status = statusMapper_1.StatusMapper.normalize(statusValue);
            // Continue to next middleware
            next();
        }
        catch (error) {
