    ...
    try {
      ...
      `);
        ...
        const inventory = await pool.request()
            .input('productId', mssql_1.default.NVarChar, prod.id)
            .query(`
        SELECT 
          pi.Id,
          pi.ProductId,
      ...
      `);
        ...
        const units = await pool.request()
            .input('storeId', mssql_1.default.NVarChar, prod.store_id)
            .query(`
        SELECT 
          id,
          name,
...
checkInventory();
//# sourceMappingURL=check-product-inventory.js.map